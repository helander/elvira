...
//extern void node_instance(void *plugin, void *preset, char *instanceName, int sampleRate, int period);
//extern void node_thread_loop(void *plugin, void *preset, char *instanceName, int sampleRate, int period);
